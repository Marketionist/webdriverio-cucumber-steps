...
variable.
34. `I/user debug(s)` - set a breakpoint to stop the tests execution and start
debugging.

### Then steps
35. `the title should be "..."` - verify that title of the current browser
window/tab equals to the text (provided in "" as a string).
36. `the title should contain "..."` - verify that title of the current browser
window/tab contains the text (provided in "" as a string).
37. `"..."."..." should be present` - verify that element (provided in
...
38. `... "..."."..." should be present` - verify that the number of elements
(provided in **"page"."object"** as CSS or XPath selector) are present on the
page (for example: `Then 4 "test2-page"."input" should be present`).
...
the page (for example: `Then 4 input from test2-page should be present`).
39. `"..."."..." should not be present` - verify that element (provided in
...
40. `"..."."..." text should be "..."` - verify that text of the element
...
41. `"..."."..." text should contain "..."` - verify that text of the element
...
42. `URL should be "..."` - verify that URL of the current page equals to the
text (provided in "" as a string).
...
43. `URL should contain "..."` - verify that URL of the current page contains
